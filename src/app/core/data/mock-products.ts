...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 79.99,
    brand: 'TravelGear',
    images: ['https://placehold.co/400x400/?text=Backpack'],
    inStock: true,
    stockQuantity: 60,
  ...
  },
  {
    ...
    price: 39.99,
    brand: 'TechWear',
    images: ['https://placehold.co/400x400/?text=Mouse'],
    inStock: true,
    stockQuantity: 100,
    category: 'Electronics',
  ...
  },
  {
    ...
    price: 24.99,
    brand: 'FashionElite',
    images: ['https://placehold.co/400x400/?text=TShirt'],
    inStock: true,
    stockQuantity: 80,
    category: 'Fashion',
  ...
  },
  {
    ...
    images: ['https://placehold.co/400x400/?text=CoffeeMaker'],
    inStock: false,
    stockQuantity: 0,
    category: 'Home',
  ...
  },
  {
    ...
    price: 69.99,
    brand: 'AudioTech',
    images: ['https://placehold.co/400x400/?text=Speaker'],
    inStock: true,
    stockQuantity: 35,
    category: 'Electronics',
  ...
  },
  {
    ...
    price: 89.99,
    brand: 'FashionElite',
    images: ['https://placehold.co/400x400/?text=Sunglasses'],
    inStock: true,
    stockQuantity: 30,
    category: 'Accessories',
  ...
  },
  {
    ...
    price: 79.99,
    brand: 'SportMax',
    images: ['https://placehold.co/400x400/?text=FitnessTracker'],
    inStock: true,
    stockQuantity: 50,
    category: 'Electronics',
  ...
  },
  {
    ...
    price: 29.99,
    brand: 'TravelGear',
    images: ['https://placehold.co/400x400/?text=WaterBottle'],
    inStock: true,
    stockQuantity: 70,
    category: 'Accessories',
  ...
  },
  {
    ...
    price: 19.99,
    brand: 'TechWear',
    images: ['https://placehold.co/400x400/?text=PhoneCase'],
    inStock: true,
    stockQuantity: 90,
    category: 'Accessories',
  ...
  },
  {
    ...
    price: 34.99,
    brand: 'HomeEssentials',
    images: ['https://placehold.co/400x400/?text=TabletStand'],
    inStock: true,
    stockQuantity: 40,
    category: 'Accessories',
