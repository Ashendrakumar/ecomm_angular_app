import { Component, OnInit, OnDestroy, inject, signal, computed, effect, ChangeDetectionStrategy, ViewChild, ElementRef, AfterViewInit } from '@angular/core';
              ...
              <div class="row g-3 align-items-end">
                <div class="col-md-6">
                  <label class="form-label">
                    ...
                    @if (appliedFiltersCount() > 0) {
                      <span class="badge bg-primary ms-2">{{ appliedFiltersCount() }} filter{{ appliedFiltersCount() > 1 ? 's' : '' }} applied</span>
                    }
                  </label>
                  <input
                    type="text"
                ...
                <div class="col-md-3">
                  <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-primary flex-fill" (click)="clearFilters()">
                      Reset
                    </button>
                  </div>
                </div>
